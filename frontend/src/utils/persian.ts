...
export const t = {
  ...
  dashboard: {
    ...
    seller: {
      ...
      subtitle: 'نمای کلی فروشگاه شما',
      totalProducts: 'کل محصولات',
      activeProducts: 'محصولات فعال',
      outOfStockProducts: 'ناموجود',
  ...
  orders: {
    ...
    dashboard: {
      ...
      totalSellers: 'تعداد فروشندگان',
    },
    management: {
      updateStatus: 'بروزرسانی وضعیت',
      statusUpdated: 'وضعیت سفارش با موفقیت بروزرسانی شد',
      statusUpdateFailed: 'خطا در بروزرسانی وضعیت سفارش',
      confirmStatus: 'آیا از تغییر وضعیت این سفارش اطمینان دارید؟',
    },
  },
  profile: {
    title: 'پروفایل',
