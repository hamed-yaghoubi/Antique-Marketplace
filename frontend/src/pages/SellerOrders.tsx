  ...
  return (
    <div>
      ...
      <div className="mb-6 flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-antique-wood text-shadow-vintage">{t.orders.sellerOrders}</h1>
          <p className="mt-1 text-sm text-antique-sepia-light">{t.orders.sellerOrdersDescription}</p>
        </div>
      </div>
